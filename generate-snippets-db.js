...
const GIT_UPDATE_COMMAND =
  "cd evo-luvi && git fetch --all && git pull --rebase";
...
if (!hasClonedRepoBefore) {
  print(
    "Cloning runtime repository (non-recursively since only the examples are needed)..."
  );
